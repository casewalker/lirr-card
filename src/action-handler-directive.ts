...
customElements.define('action-handler-lirr-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-lirr-card')) {
    return body.querySelector('action-handler-lirr-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-lirr-card');
